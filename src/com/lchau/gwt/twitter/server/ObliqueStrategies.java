...
/**
 * Generated messages from Oblique Strategies (all messages pass {@link TweetVerifier}).
 *
 * @author Lam Chau
 */
public enum ObliqueStrategies {
  ;
  // immutable list
  public static final List<String> ALL_MESSAGES =
      Collections
  ...
  /**
   * Returns a uniform random oblique strategy.
   *
   * @return a random oblique strategy
   */
  public static String nextMessage() {
    final int index = random.nextInt(ALL_MESSAGES.size() + 1);
    return ALL_MESSAGES.get(index);
  }
